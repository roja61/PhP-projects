...
<div class="main-content" style="margin-top: 5%;margin-left: 2%;">
    ...
    <div id="page-wrapper" style="background: #fff; width:100%;">
        <div class="main-page">
            <div class="forms">
                <h3 class="title1">Deposit Statements</h3>
                <?php
            ...
            <div class="tables">
                    ...
                    $strSQL = "SELECT * from transactions where custmer_id='".$_POST['customer_id']."' and deposit_withdraw_transfer='Deposit' and (transaction_date >= '".$_POST['from_date']."' and transaction_date <= '".date('Y-m-d H:i:s',strtotime('+23 hour +59 minutes +59 seconds',strtotime($_POST['to_date'])))."') order by transaction_date DESC ";
                    ...
                    if (mysql_num_rows($rs) == 0) {
                        ...
                        <div class="alert alert-info" id="danger-alert">
                            <button type="button" class="close" data-dismiss="alert">×</button>
                            <strong> There is no Deposits Added by User.. </strong>
                        </div>
                    <?php } else {
                        ?>
