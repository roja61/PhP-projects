...
<div class="main-content" style="margin-top: 5%;margin-left: 10%;">
    ...
    <div id="page-wrapper" style="background: #fff;">
        <div class="main-page">
            <div class="tables">
                <h3 class="title1">List Withdraws</h3> 
                    ...
                    $strSQL = "SELECT * from transactions where custmer_id='".$_SESSION['customerId']."' and deposit_withdraw_transfer='WithDraw' order by transaction_date DESC ";
                    ...
                    if (mysql_num_rows($rs) == 0) {
                        ...
                        <div class="alert alert-info" id="danger-alert">
                            <button type="button" class="close" data-dismiss="alert">×</button>
                            <strong> There is no WithDraws by you.. </strong>
                        </div>
                    <?php } else {
                        ?>
                            ...
                            <table class="table"> 
                                <thead> 
                                    <tr> 
                                        ...
                                        <th>Performed On</th> 
                                         <th>Description</th> 
                                        <th>WithDrawn Amount(In Dollars)</th>
                                    </tr> 
                                </thead> 
                                <tbody> 
                                    <?php
