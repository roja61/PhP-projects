    ...
    <div id="page-wrapper" style="background: #fff;">
        <div class="main-page">
            ...
            <div class="tables">
                    ...
                    $strSQL = "SELECT * from transactions where custmer_id='".$_SESSION['customerId']."' and deposit_withdraw_transfer='Deposit' and (transaction_date >= '".$_POST['from_date']."' and transaction_date <= '".date('Y-m-d H:i:s',strtotime('+23 hour +59 minutes +59 seconds',strtotime($_POST['to_date'])))."') order by transaction_date DESC ";
