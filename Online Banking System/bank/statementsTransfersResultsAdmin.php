    ...
    <div id="page-wrapper">
        <div class="main-page">
            ...
            <div class="tables">
                    ...
                    $strSQL = "SELECT * from transactions t LEFT JOIN customers c on c.id=t.to_cust_id where t.from_cust_id='".$_POST['customer_id']."' and deposit_withdraw_transfer='Transfer' and (transaction_date >= '".$_POST['from_date']."' and transaction_date <= '".date('Y-m-d H:i:s',strtotime('+23 hour +59 minutes +59 seconds',strtotime($_POST['to_date'])))."') order by transaction_date DESC ";
                    ...
                    if (mysql_num_rows($rs) == 0) {
                        ...
                        <div class="alert alert-info" id="danger-alert">
                            <button type="button" class="close" data-dismiss="alert">×</button>
                            <strong> There is no Transfers Added by User.. </strong>
                        </div>
                    <?php } else {
                        ?>
